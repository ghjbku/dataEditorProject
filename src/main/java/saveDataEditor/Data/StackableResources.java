...
public class StackableResources {
    private final Map<Integer, ResourceInformation> gatheringResources = new HashMap<>();
    private final Map<Integer, ResourceInformation> miningResources = new HashMap<>();
    private final Map<Integer, ResourceInformation> beastCoreResources = new HashMap<>();
